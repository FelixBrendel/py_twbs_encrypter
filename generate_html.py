...
for org_file, org_key in zip(org_files, keys):
    ...
    with open(generated_file, "r") as html:
        ...
        if org_key:
            ...
            body =  "aalkdjalkdsjalkdja alsdkjal kjalskdj lakjd ökljföal kjfaölksjf ölaskjf öalkjf öalkjföak jöakfj ölkjföalkjf lak"
...
<script type="text/javascript" src="decipher.js"></script></head>""")
